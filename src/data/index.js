...
export const testimonials = [
  ...
  { text:"We went from 3.8 to 4.7 stars on Google in six weeks. The review agent is clever — happy patients get the link, unhappy ones reach me first. No bad reviews have gone public since.", name:'Dr. Vikram Nair', role:'Dental Surgeon, Pune',     init:'V' },
  { text:"My receptionist used to spend 2 hours a day on WhatsApp. Now she focuses on patients. The AI handles everything — in Hindi, English, even Marathi mix. Patients love it.", name:'Dr. Sunita Joshi', role:'Gynaecologist, Thane',       init:'S' },
]
...
// ─── About: Why WhatsApp nums ────────────────────────────────────────────────
export const whyWaNums = [
  { big:'500M+', label:'Indians on WhatsApp daily — the largest install base of any messaging platform' },
...
export const agentPanels = [
  ...
  },
  {
    ...
    flow:[
      ...
      { icon:'⚡', label:'WhatsApp in 3s',      sub:'"Your call received, we\'ll connect shortly"' },
...
export const pricingPlans = [
  {
    ...
    price:'₹999', period:'per month + ₹1,999 one-time setup',
    featured: false,
  ...
  },
  {
    ...
    price:'₹4,999', period:'per month + ₹3,999 one-time setup',
  ...
  },
  {
    ...
    price:'Custom', period:"Let's talk about your setup",
    featured: false,
...
export const faqs = [
  ...
  { q:'What happens to my existing WhatsApp conversations?', a:'Agents only activate for new messages from new or inactive patients. Ongoing conversations you\'re managing can be handled as before. We configure the exact logic together during onboarding.' },
  { q:'Which virtual number service do I need for the Missed Call agent?', a:'We work with Exotel and MSG91 — both widely used in India. If you already have one, we connect directly. If not, we can help you set one up. The process takes about 24 hours.' },
  { q:'Can the agents speak Hindi?',                      a:'Yes. All agents handle Hindi, English, and Hinglish naturally. Patients can switch mid-conversation and the agent follows. We can also configure default language per agent.' },
  { q:'What if a patient asks something the AI can\'t handle?', a:"The agent escalates gracefully — it notifies your number or receptionist and tells the patient that a team member will follow up. No patient ever gets stuck." },
  { q:'Is there a contract or minimum commitment?',       a:"No contract. Month-to-month billing. Cancel anytime with 30 days notice. We operate this way because we're confident the agents deliver measurable results — and you should only pay for something that's working." },
  { q:'Do you offer in-person demos for Mumbai clinics?', a:"Yes. If you're based in Mumbai, we can come to your clinic for the demo. We'll run the agent on your phone, walk you through the conversation flows, and answer questions from your staff." },
]
